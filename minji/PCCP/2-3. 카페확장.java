public class PG_15009_121689 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(pg_15009_121689.solution(new int[]{5, 12, 30}, new int[]{1, 2, 0, 1}, 10)); // expected : 3
        System.out.println(pg_15009_121689.solution(new int[]{5, 12, 30}, new int[]{2, 1, 0, 0, 0, 1, 0}, 10)); // expected : 4
        System.out.println(pg_15009_121689.solution(new int[]{5}, new int[]{0, 0, 0, 0, 0}, 5)); // expected : 1
    }
}
